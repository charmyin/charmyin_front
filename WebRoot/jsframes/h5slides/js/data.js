...
define(['storage'], function (storage) {
    ...
    var defaultData = {
        ...
        slides: [
            ...
            {sid: 'i', template: 'zebonebody', layout: 'zebonebody', items: {title: {type: 'text', value: '工作成果汇报-前端框架架构'}, content: {type: 'text', value: '<a href="http://192.168.1.199:8080/bbrj/jsframes/zeboneui/app/templates/easyui/login/login.html" target="_blank"><img src="images/zebone/zeboneui.png" title="Zebone 研发平台入口" alt="Zebone 研发平台入口" style="height:353px; float:left; width:544px; border:solid blue 1px;"/></a>'}}},
            ...
            {sid: 'l', template: 'zebonebody', layout: 'zebonebody', items: {title: {type: 'text', value: '结束语'}, content: {type: 'text', value: ' <iframe src="../threejs/demo/canvas_particles_shapes.html"  style="height:353px; float:left; width:544px; border:solid blue 1px;"></iframe >'}}}
